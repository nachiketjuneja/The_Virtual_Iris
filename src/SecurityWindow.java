...
public class SecurityWindow extends javax.swing.JFrame {
    ...
    /**
     * Creates new form SecurityWindow
     */
    public SecurityWindow() throws Exception {
        initComponents();
        
        Registry reg= LocateRegistry.createRegistry(2000);
        System.out.println("server is ready");
        CheckLogin cl=new CheckLogin();
        reg.bind("AUTHORIZED", cl);
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Let me veify it's you!! ");
        jLabel5.setOpaque(true);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/unnamed.gif"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      LoginInterface li=(LoginInterface)reg.lookup("AUTHORIZED");
boolean result=li.check(userName, password);
if(result)
{
    
        
    JOptionPane.showMessageDialog(null,"Authenticated! Welcome...");
...
else
{
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SecurityWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(SecurityWindow.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
